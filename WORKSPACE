...
maven_install(
    artifacts = [
        ...
        "com.google.ar.sceneform.ux:sceneform-ux:aar:1.6.0"
    ],
    repositories = [
...
''' maven_jar(
    name = "com_google_ar_core",
    artifact = "com.google.ar:core:jar:1.16.0",
    server = "google_server",
) '''

''' maven_jar(
    name = "com_google_ar_sceneform_ux",
    artifact = "com.google.ar.sceneform.ux:sceneform-ux:1.6.0",
) '''
